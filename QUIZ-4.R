...
rf_accuracy <- length(rf_outcome[rf_index])/length(vowel.test$y)
...
gbm_accuracy <- length(gbm_outcome[gbm_index])/length(vowel.test$y)

both_agree_accuracy<- length(vowel.test$y[rf_index|gbm_index])/length(vowel.test$y)
